<template>
    <div class="register horizontal-center">
        <el-steps :active="active" class="register-step" finish-status="success">
            <el-step title="联系方式"></el-step>
            <el-step title="登录注册"></el-step>
            <el-step title="帐户信息"></el-step>
        </el-steps>
        <div class="form">
            <el-form :model="form" :rules="formRules" ref="Form1" label-width="100px" v-show="active === 0">
                ...
                <el-form-item prop="verifycode" label="手机验证码">
                    <el-input v-model="form.verifycode" placeholder="获取短信验证码">
            ...
            <el-form :model="form" :rules="formRules" ref="Form2" label-width="100px" v-show="active === 1">
                <div class="register-type">
                    <span :class="registerEmailType" @click="toggleRegisterType('email')">邮箱注册<span></span></span>
                    <span :class="registerPhoneType" @click="toggleRegisterType('phone')">手机注册<span></span></span>
                </div>
                <template v-if="curRegisterType === 'email'">
                    ...
                    <el-form-item prop="confirmPassword" label="密码确认">
                        <el-input v-model="form.confirmPassword" placeholder="密码确认" show-password></el-input>
                    </el-form-item>
                ...
                <el-form-item prop="agree">
                    <el-checkbox v-model="form.agree">
                        ...
                        <a href="#" class="link link-blue-text">服务协议</a>
                        <span class="default-color">和</span>
                        <a href="#" class="link link-blue-text">隐私条款</a>
                    </el-checkbox>
                </el-form-item>
                <el-button type="primary" :disabled="!form.agree" @click="check">注册</el-button>
            </el-form>
            <el-form :model="form" :rules="formRules" ref="Form3" label-width="100px" v-show="active === 2">
                <el-form-item prop="accountName" label="帐户名称">
                    <el-input v-model="form.accountName" placeholder="请输入帐户名称"></el-input>
                </el-form-item>
                ...
                <el-button type="primary" :disabled="!form.agree" @click="check">完成</el-button>
            </el-form>
            <div class="register-success" v-show="active === 3">
                注册成功，正在跳转...
            </div>
        </div>
    </div>
